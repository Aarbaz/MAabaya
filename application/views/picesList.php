                  ...
                  if (1 == 1) {
                    ...
                    <td>
                      <a class="btn btn-primary btn-xs" title="Click to download"
                        href="<?php echo base_url('/index.php/Pices/downloadPdf/') . rawurlencode($results[0]->id) . '/' . $row->invoice_no; ?>"><i
                          class="glyphicon glyphicon-download"></i></a>&nbsp;
                      <a class="btn btn-primary btn-xs" title="Click to edit"
                        href="<?php echo base_url('/index.php/Pices/editPices/') . $row->sr_no; ?>"><i
    ...
    <div class="modal-content">
      <form id="delete_form" method="post" action="<?php echo site_url('/Pices/deletePices'); ?>">
        ...
        <div class="modal-footer ">
          <button type="button" class="btn btn-success" id="yes"><span
