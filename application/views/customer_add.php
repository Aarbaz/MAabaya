        ...
        <div class="panel-body">
          ...
          ?>      
            <div class="form-group">
              <div class="col-sm-5">
                <input type="text" class="form-control" id="bakery_name" name="bakery_name" placeholder="Customer Name" value="<?php echo set_value('bakery_name'); ?>">
              </div>
            ...
            <div class="form-group">
              <div class="col-sm-5">
                <textarea class="form-control" id="bakery_adds" name="bakery_adds" placeholder="Shop Adds"><?php echo set_value('bakery_adds'); ?></textarea>
              </div>
