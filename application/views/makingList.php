            ...
            <div class="panel-heading">
               <h4>
                  <?php echo ucwords($username) . ', '; ?><small>
                     <?php echo date('d F, Y'); ?>
                  </small><span class="text-sm pull-right"><a href="<?php echo site_url('Making/logout'); ?>">Log
                        Out</a></span>
               </h4>
            </div>
            <div class="panel-body">
               <p>
                  <a class="btn btn-primary btn-sm" href="<?php echo base_url('/index.php/Making/add_new'); ?>">Add New
                  </a>
               </p>
               <br />
               <?php
                           ...
                           <tr>
                              ...
                              <td>
                                 ...
                                 <a class="btn btn-primary btn-xs" title="Click to download"
                                    href="<?php echo base_url('/index.php/Making/download_pdf/') . rawurlencode($row->making_owner_id) . '/' . $row->maker_no; ?>"><i
                                 ...
                                 <a class="btn btn-primary btn-xs" title="Click to edit"
                                    href="<?php echo base_url('/index.php/Making/edit/') . $row->id; ?>"><i
      ...
      <div class="modal-content">
         <form id="delete_form" method="post" action="<?php echo site_url('/Making/deleteMaking'); ?>">
            ...
            <div class="modal-footer ">
               <button type="button" class="btn btn-success" id="yes"><span class="glyphicon glyphicon-ok-sign"></span>
                  Yes</button>
