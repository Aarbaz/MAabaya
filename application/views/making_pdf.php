...
<body>
  ...
  <table class="hdr" style="width: 100%">
    ...
    <!--  <tr>
      ...
      <td> <?php if ($date_of_supply) {
        echo date('d F, Y', strtotime($date_of_supply));
      } ?> </td>
    </tr> -->
    <!-- <tr>
      <td>&nbsp;</td> <td>&nbsp;</td>
    ...
    if ($all_items > 0) {
      for ($i = 0; $i < 20; $i++) { ?>
        <tr>
          ...
          <td>
            <?php echo isset($items2[$i][0]) ? $items2[$i][0] : ''; ?>
          </td>
          <!-- <td>-</td> -->
          <td>
            <?php echo isset($items2[$i][1]) ? $items2[$i][1] : ''; ?>
          </td>
          <!-- <td>-</td>
          <td>-</td> -->
  ...
  <?php } ?> -->
    <tr>
      ...
      <!-- <td>&nbsp;</td> -->
      <td>
        <?php echo $Final_total_qty . ' Meters.' ?>
      </td>
    </tr>
