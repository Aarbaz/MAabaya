            ...
            <div class="panel-heading">
               <h4>
                  <?php echo ucwords($username) . ', '; ?><small>
                     <?php echo date('d F, Y'); ?>
                  </small><span class="text-sm pull-right"><a href="<?php echo site_url('Purchaser/logout'); ?>">Log
                        Out</a></span>
               </h4>
            </div>
            <div class="panel-body">
               <p data-placement="top" data-toggle="tooltip">
                  <a class="btn btn-primary btn-sm" href="<?php echo base_url('/index.php/Purchaser/'); ?>">Go back to
                     Purchaser list</a>
               </p>
               <hr />
               <?php
               ...
               <div class="form-group">
                  <div class="col-sm-5">
                     ...
                     <select name="owner_name" id="owner_name" class="form-control selectpicker"
               ...
               <div class="form-group" id="table_without_tax">
                  <table class="table table-bordered">
                     ...
                     <tbody id="purchaser_addTable_body">
                        <tr class="row_one">
                           <td class="">
                           ...
                           <td>
                              <input type="text" class="form-control qnty" id="stock_q" name="stock_q[]"
                                 placeholder="Meters" value="<?php echo set_value('price'); ?>">
                           </td>
                           <td>
                              <input type="text" class="form-control rate" id="price" name="p_price[]"
                                 placeholder="Price" value="<?php echo set_value('price'); ?>">
                           </td>
                           <td>
                              <input type="text" class="form-control amount" id="price_total" name="price_total[]"
                                 placeholder="Total Amount" value="" readonly="readonly">
                           </td>
                           <td>
                              <button type="button" name="add_more" id="add_more"
                                 class="add_more btn btn-success btn-sm" fdprocessedid="1s22ut"><b>+</b></button>
                              &nbsp;<button type="button" name="remove" id="remove"
                                 class="btn btn-warning btn-sm remove" fdprocessedid="vik1a"><b>X</b></button>
                           </td>
                        </tr>
                        <tr class="row_two">
                           <td>
                           ...
                           <td>
                              <div class="col-sm-12">
                                 <?php echo form_error('p_price[]', '<p class="text-danger">', '</p>'); ?>
                              </div>
                           </td>
                        </tr>
                     </tbody>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-3">
                     <input type="text" name="total_amount" id="total_amount" readonly="readonly"
                        class="total form-control" style="display: inline; width: 50%" value="" size="3">
                  </div>
               </div>
               <div class="form-group">
                  <div class="col-sm-2 col-sm-offset-6">
                  ...
                  <div class="col-sm-3">
                     <input type="text" name="total_round" id="total_round" readonly="readonly" class="form-control"
                        style="display: inline; width: 50%" value="" size="3">
                  </div>
               </div>
               <div class="form-group ">
                  <div class="col-sm-2 col-sm-offset-6">
               ...
               <div class="form-group ">
                  ...
                  <div class="col-sm-3">
                     <input type="text" name="balance_amount" class="form-control only_num balance_amount"
                        id="balance_amount" style="display: inline; width: 50%" value="" size="3">
                  </div>
               </div>
               <div class="form-group">
      ...
      <div class="modal-content">
         <form id="add_material_form" method="post" action="<?php echo site_url('/Purchaser/add_material'); ?>">
            ...
            <div class="modal-footer " style="margin-top: 50px;">
               <div class="col-sm-12">
                  <button type="submit" class="btn btn-success" id="insert_update"><span
            ...
            <div class="modal-body">
               <div class="col-sm-12">
                  <div class="form-group">
                     ...
                     <div class="col-sm-9" id="design_holder">
                        <input type="text" name="owner_name_inside" id="owner_name_inside" class="form-control"
                           value="">
                        <div class="col-sm-12">
                           <?php echo form_error('owner_name_inside', '<p class="text-danger">', '</p>'); ?>
                        </div>
