      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4>
            <?php echo ucwords($username) . ', '; ?><small>
              <?php echo date('d F, Y'); ?>
            </small><span class="text-sm pull-right"><a href="<?php echo site_url('Customer/logout'); ?>">Log
                Out</a></span>
          </h4>
        </div>
        ...
        <div class="panel-body">
          <p data-placement="top" data-toggle="tooltip">
            <a class="btn btn-primary btn-sm" href="<?php echo base_url('/index.php/Material/'); ?>">Go back to Material
              list</a>
          </p>
          <hr />
          <?php
          echo form_open('Material/add_material', 'class="form-horizontal" id="add_material_form"');
          ?>
          <div class="form-group">
            <div class="col-sm-5">
              <input type="text" class="form-control" id="material_name" name="material_name"
                placeholder="Material Name" value="<?php echo set_value('name'); ?>">
            </div>
            <div class="col-sm-6">
          ...
          <div class="form-group" id="address_div" style="display:none">
            <div class="col-sm-5">
              <textarea class="form-control" id="address" name="address"
                placeholder="Shop Adds"><?php echo set_value('address'); ?></textarea>
            </div>
            <div class="col-sm-6">
          ...
          <div class="form-group hide">
            <div class="col-sm-5">
              <input type="text" class="form-control" id="last_amount" name="last_amount" placeholder="Last Amount"
                value="<?php echo set_value('last_amount'); ?>">
            </div>
            <div class="col-sm-6">
              <?php echo form_error('last_amount', '<p class="text-danger">', '</p>'); ?>
            </div>
          </div>

          <div class="form-group">
            <div class="col-sm-5">
              <?php echo form_submit('add_customer', 'Add Material', 'class="btn btn-success"'); ?>
            </div>
            <div class="col-sm-6">
              <?php
