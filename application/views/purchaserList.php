      ...
      <div class="col-sm-12">
         <div class="panel panel-default">
            ...
            <div class="panel-body">
               <p>
                  <a class="btn btn-primary btn-sm" href="<?php echo base_url('/index.php/Purchaser/add_new'); ?>">Add
                     New</a>
               </p>
               <br />
               <?php
                           ...
                           <tr>
                              ...
                              <td>
                                 <a class="btn btn-primary btn-xs" title="Click to download"
                                    href="<?php echo base_url('/index.php/Purchaser/download_pdf/') . rawurlencode($row->purchaser_owner_id) . '/' . $row->purchaser_no; ?>"><i
