         ...
         <div class="panel panel-default">
            ...
            <div class="panel-body">
               <p data-placement="top" data-toggle="tooltip">
                  <a class="btn btn-primary btn-sm" href="<?php echo base_url('/index.php/Making/'); ?>">Go back to
                     Making list</a>
               </p>
               <hr />
               <?php
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-12">
                     <?php echo form_error('master_name', '<p class="text-danger">', '</p>'); ?>
                  </div>
                  ...
                  <table class="table table-bordered">
                     ...
                     <tbody id="rows-list">
                        <tr>
                           ...
                           <td>
                              <input type="text" class="form-control" id="stock_q" name="stock_q[]"
                                 placeholder="Quantity" value="<?php echo set_value('price'); ?>">
                           </td>
                           <td>
               ...
               <div class="col-sm-12">
                  <div class="form-group">
                     ...
                     <div class="col-sm-9" id="design_holder">
                        <input type="text" name="master_name_inside" id="master_name_inside" class="form-control"
                           value="">
                        <div class="col-sm-12">
                           <?php echo form_error('master_name_inside', '<p class="text-danger">', '</p>'); ?>
                        </div>
