  ...
  <div class="row">
        ...
        <div class="panel-body">
          <p data-placement="top" data-toggle="tooltip">
            <a class="btn btn-primary btn-sm" href="<?php echo base_url('/index.php/Design/');?>">Go back to Design list</a>
          </p> <hr />
          <?php
            echo form_open('Design/add_design', 'class="form-horizontal" id="add_design_form"');
          ?>
            <div class="form-group">
              <div class="col-sm-5">
                <input type="text" class="form-control" id="design_name" name="design_name" placeholder="Design Number" value="<?php echo set_value('name'); ?>">
              </div>
          ...
          <div class="form-group">
            <div class="col-sm-5">
              <?php echo form_submit('add_design','Add Design','class="btn btn-success"'); ?>
            </div>
             <div class="col-sm-6">
              <?php
